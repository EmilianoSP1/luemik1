...
export default function AccesoriosCatalogo({ user = null }) {
  ...
  return (
    <>
      <Head title="Catálogo · Accesorios | Luemik" />
      <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <section className="pt-28 md:pt-32 pb-10 text-center px-6">
          <h1 className="text-4xl md:text-6xl font-black tracking-tight">ACCESORIOS</h1>

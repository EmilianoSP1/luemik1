// resources/js/Pages/Catalogo/Turtle Neck/turleneck.jsx
...
export default function TurleneckCatalogo({ user = null }) {
  // --- Estados Header ---
  ...
  // --- Triptych (mismas imágenes y hrefs que en playeras.jsx) ---
  ...
  /* ===================== PRODUCTOS (idénticos a playeras.jsx) ===================== */
  const PRODUCTS = [
  ...
  return (
    <>
      <Head title="Catálogo · Turtle Neck | Luemik" />
      <div className="relative min-h-screen bg-neutral-950 text-white">
        ...
        <section className="pt-28 md:pt-32 pb-6 text-center px-6">
          <h1 className="text-4xl md:text-6xl font-black tracking-tight">TURTLE NECK</h1>
          <div className="mt-4 inline-block rounded-md bg-lime-400 px-4 py-2 text-black font-semibold">
            Cuello alto · secado rápido
          </div>
        </section>
        ...
        <section id="grid" className="px-4 md:px-8 pb-28">
          <div className="mx-auto max-w-7xl">
            <div className="flex items-end justify-between mb-6">
              <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight">Turtle Neck</h2>
